...
// via `poll_rx()`.
//
// The radio runs the Meshtastic LongFast preset: SF11, BW 250 kHz, CR 4/5,
// sync 0x2B, preamble 16, +22 dBm. Slot frequency is `xorHash("LongFast") %
...
// First-time init. Brings the radio up using the Meshtastic LongFast preset
...
// Re-apply the Meshtastic LongFast preset for the given region. Used by the
// BLE RADIO_SET_REGION handler.
